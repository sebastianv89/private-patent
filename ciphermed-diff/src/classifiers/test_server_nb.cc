...
static void read_prob_file(const string &filename, vector<double> &prior_vec, vector<vector<double>> &conditionals_vec)
{
    Json::Value root;
    Json::Reader reader;
...
//    cerr << "priors: " << prior_vec << endl;
    ...
    conditionals_vec = vector<vector<double>>(
                                                      json_const_iterator< vector<double> >(conditionals.begin()),
                                                      json_const_iterator< vector<double> >(conditionals.end()));
    
}

static void test_nb_classifier_server(const vector<vector<double>> &conditionals_vec, const vector<double> &prior_vec)
{
#ifdef BENCHMARK
...
{
    vector<vector<double>> conditionals_vec;
